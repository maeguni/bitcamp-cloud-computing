//주제:Node.js소개 
//Node.js?
// -구글에서 고개한 V8 자바스크립트 엔진을 사용하여 
//  웹브라우저 밖에서도  자바스크립트를 실행 할수 있도록 만든 프로그램이다.
//- 자바스크립트 기본  API를 그대로 사용할 수 있
//- 웹브라우저에서 실행하는 것이 아니기 떄문에
...
// -주로 마이크로 서비스를 만들 때 Node.js를 사용함으로써 인해
// Node.js가 서버 프로그램 용으로 오해하는 경우가 많다.
//  
//
//사용법
// >node 파일묭
// >node ex01.sj
// >node src/sep01/ex01.sj
//
