...
CREATE TABLE P1_SUDO (
    ...
    LAT_SHOL VARCHAR(50)  NOT NULL COMMENT '최종학력', -- 최종학력
...
-- 학생
ALTER TABLE P1_SUDO
    ADD CONSTRAINT PK_P1_SUDO -- 학생 기본키
        PRIMARY KEY (
            SNO -- 학생번호
        );
...
ALTER TABLE P1_TGH_SUB
    ADD CONSTRAINT PK_P1_TGH_SUB -- 강의과목 기본키
        PRIMARY KEY (
            SNO, -- 과목번호
            MNO  -- 강사번호
        );
...
ALTER TABLE P1_PRJ_MEM
    ADD CONSTRAINT PK_P1_PRJ_MEM -- 프로젝트참여자 기본키
        PRIMARY KEY (
            PNO, -- 프로젝트번호
            SNO  -- 학생번호
        );
...
CREATE TABLE P1_ADDR (
    AD       INTEGER      NOT NULL COMMENT '주소번호', -- 주소번호
...
ALTER TABLE P1_ADDR
    MODIFY COLUMN AD INTEGER NOT NULL AUTO_INCREMENT COMMENT '주소번호';
...
CREATE TABLE P1_MEMB (
    ...
    NAEM  VARCHAR(50)  NOT NULL COMMENT '이름', -- 이름
...
-- 수강신청
ALTER TABLE P1_APPL
    ADD CONSTRAINT FK_P1_SUDO_TO_P1_APPL -- 학생 -> 수강신청
        FOREIGN KEY (
            SNO -- 학생번호
        )
        REFERENCES P1_SUDO ( -- 학생
            SNO -- 학생번호
        );
...
-- 학생
ALTER TABLE P1_SUDO
    ADD CONSTRAINT FK_P1_ADDR_TO_P1_SUDO -- 주소 -> 학생
        FOREIGN KEY (
            ADRNO -- 주소번호
        )
...
-- 학생
ALTER TABLE P1_SUDO
    ADD CONSTRAINT FK_P1_MEMB_TO_P1_SUDO -- 회원 -> 학생
        FOREIGN KEY (
            SNO -- 학생번호
        )
...
-- 강의과목
ALTER TABLE P1_TGH_SUB
    ADD CONSTRAINT FK_P1_TCH_TO_P1_TGH_SUB -- 강사 -> 강의과목
        FOREIGN KEY (
            MNO -- 강사번호
        )
...
-- 강의과목
ALTER TABLE P1_TGH_SUB
    ADD CONSTRAINT FK_P1_SUB_TO_P1_TGH_SUB -- 과목 -> 강의과목
        FOREIGN KEY (
            SNO -- 과목번호
        )
...
-- 프로젝트참여자
ALTER TABLE P1_PRJ_MEM
    ADD CONSTRAINT FK_P1_PRJ_TO_P1_PRJ_MEM -- 프로젝트 -> 프로젝트참여자
        FOREIGN KEY (
            PNO -- 프로젝트번호
        )
...
-- 프로젝트참여자
ALTER TABLE P1_PRJ_MEM
    ADD CONSTRAINT FK_P1_SUDO_TO_P1_PRJ_MEM -- 학생 -> 프로젝트참여자
        FOREIGN KEY (
            SNO -- 학생번호
        )
        REFERENCES P1_SUDO ( -- 학생
...
-- 교육과정수강생
ALTER TABLE P1_CORS_STUD
    ADD CONSTRAINT FK_P1_SUDO_TO_P1_CORS_STUD -- 학생 -> 교육과정수강생
        FOREIGN KEY (
            SNO -- 학생번호
        )
        REFERENCES P1_SUDO ( -- 학생
